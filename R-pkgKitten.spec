...
Version  : 0.2.4
Release  : 44
URL      : https://cran.r-project.org/src/contrib/pkgKitten_0.2.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgKitten_0.2.4.tar.gz
...
%setup -q -n pkgKitten
pushd ..
cp -a pkgKitten buildavx2
popd
pushd ..
cp -a pkgKitten buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725295286
...
/usr/lib64/R/library/pkgKitten/replacements/test_hello.R
